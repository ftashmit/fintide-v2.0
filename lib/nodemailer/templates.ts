...
//                                Fintide HQ, CCU, WB, IN<br>
//                                 <a href="#" style="color: #CCDADC !important; text-decoration: underline;">Unsubscribe</a> | 
//                                 <a href="" style="color: #CCDADC !important; text-decoration: underline;">Visit Fintide</a><br>
//                                 © 2025 Fintide
//                             </p>
//                         </td>
//                     </tr>
...
<head>
    ...
    <meta name="format-detection" content="telephone=no">
    <meta name="x-apple-disable-message-reformatting">
    <title>Welcome to Fintide</title>
    <!--[if mso]>
    <noscript>
        <xml>
            <o:OfficeDocumentSettings>
        ...
        <tr>
            <td align="center" class="mobile-outer-padding" style="padding: 40px 20px;">
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" class="email-container" style="max-width: 600px; background-color: #141414; border-radius: 8px; border: 1px solid #30333A;">
                    ...
                    <tr>
                        <td align="left" class="mobile-header-padding" style="padding: 40px 40px 20px 40px;">
                            <h2 style="margin: 0; font-size: 24px; font-weight: bold; color: #ffffff;">Fintide</h2>
                        </td>
                    </tr>
                    
                    <!-- Title Section -->
                    <tr>
                        <td align="left" class="mobile-padding" style="padding: 0 40px 24px 40px;">
                            <h1 class="mobile-title" style="margin: 0; font-size: 32px; font-weight: bold; color: #ffffff; letter-spacing: -0.5px;">
                                Welcome to your new <br>
                                <span style="color: #10b981;">market cockpit.</span>
                            </h1>
                        </td>
                    </tr>
                    ...
                    <!-- Content -->
                    <tr>
                        <td align="left" class="mobile-padding" style="padding: 0 40px 32px 40px;">
                            <p class="mobile-text" style="margin: 0 0 24px 0; font-size: 16px; line-height: 1.6; color: #9ca3af;">
                                Thanks for joining Fintide. You've just taken the first step towards a clutter-free trading environment.
                            </p>
                            <p class="mobile-text" style="margin: 0 0 24px 0; font-size: 16px; line-height: 1.6; color: #9ca3af;">
                                Your dashboard is ready. Set up your first watchlist, configure price alerts, and start tracking the market with zero noise.
                            </p>
                        </td>
                    </tr>
                    ...
                    <!-- CTA Button -->
                    <tr>
                        <td align="left" class="mobile-padding mobile-button" style="padding: 0 40px 40px 40px;">
                            <a href="https://fintide.com/dashboard" target="_blank" style="background-color: #10b981; color: #ffffff; padding: 14px 32px; border-radius: 6px; text-decoration: none; font-weight: 600; font-size: 16px; display: inline-block; transition: background-color 0.2s;">
                                Go to Dashboard
                            </a>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td align="center" style="padding: 0 40px;">
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                <tr>
                                    <td style="border-top: 1px solid #30333A;"></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                    ...
                    <!-- Footer -->
                    <tr>
                        <td align="left" class="mobile-padding" style="padding: 32px 40px 40px 40px;">
                            <p class="mobile-text" style="margin: 0 0 8px 0; font-size: 14px; color: #6b7280;">
                                © 2025 Fintide. All rights reserved.
                            </p>
                            <p class="mobile-text" style="margin: 0; font-size: 14px; color: #6b7280;">
                                You received this email because you signed up for Fintide.
                            </p>
                        </td>
                    </tr>
